...
import com.yjh.blog.web.dto.posts.PostsListResponseDto;
...
public class PostsService {
    ...
    public Long update(Long id, PostsUpdateRequestDto requestDto) {
        ...
        posts.update(requestDto.getTitle(), requestDto.getContent(), requestDto.getClassification(), requestDto.getFileId());
        return id;
